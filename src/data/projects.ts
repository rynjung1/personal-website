...
export const projects: Project[] = [
  {
    title: "Pathfinder Run",
    link: "https://github.com/rynjung1/pathfinder-run",
    description: "Scenic Loop Route Generator for Runners",
    imgUrl: "/projects/pathfinder-run.png",
    alt: "Runner on a winding tree-lined park path at a misty sunrise",
    chips: [
      { text: "React Native", color: "61DAFB" },
      { text: "Python", color: "3776AB" },
      { text: "Flask", color: "3BABC3" },
      { text: "GraphHopper", color: "ED8B00" },
      { text: "SQLite", color: "0F80CC" },
    ],
  },
  {
    title: "Transaction Calendar Sync",
    link: "https://github.com/rynjung1/transaction-calendar-sync",
    description: "Bank Transactions as a Passive Calendar Spending Diary",
    imgUrl: "/projects/transaction-calendar-sync.png",
    alt: "Phone showing a calendar of colored events beside a credit card at night",
    chips: [
      { text: "React Native", color: "61DAFB" },
      { text: "TypeScript", color: "3178C6" },
      { text: "Supabase", color: "3FCF8E" },
      { text: "Plaid", color: "A0A0A0" },
      { text: "Vercel", color: "E5E5E5" },
    ],
  },
  {
    title: "Job Application Tracker",
    link: "https://github.com/rynjung1/job-app-tracker",
    description: "Chrome Extension That Auto-Logs Applications to Google Sheets",
    imgUrl: "/projects/job-app-tracker.png",
    alt: "Laptop showing a spreadsheet in a dim apartment overlooking a city at night",
    chips: [
      { text: "TypeScript", color: "3178C6" },
